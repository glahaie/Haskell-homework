...
trXX 9 = testXX "#9. lesComposantsDuType : agencement plusieurs composants, un composant"
         (map lIdComposant (lesComposantsDuType ag Coin) == ["b1"])
trXX 10 = testXX "#9. lesComposantsDuType : agencement plusieurs composants, plusieurs composants"
...
trXX 17 = testXX "#17. connecterUn : liste de 1 bloc avec bloc non conectable"
